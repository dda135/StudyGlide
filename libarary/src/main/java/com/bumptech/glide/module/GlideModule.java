 ...
 * </p>
 *
 * Glide通过<meta-data android:name="package.YourModule" android:value="GlideModule" />加载Module。
 *用途：
 *1.在即将构建Glide的时候改变GlideBuilder的配置以用于生成不同的Glide
 *2.生成Glide之后立刻往里面注册组件，比方说自定义的一些LoadModel之类的
 */
public interface GlideModule {
     ...
     * created.
     * 注意一下该方法会在GlideBuilder创建Glide之前调用，主要作用是修改GlideBuilder的参数
     *
     * <p>
     ...
     * started.
     * 在Glide创建完成之后会立即调用该方法，主要作用是往Glide里面注册一些回调
     *
     * <p>
     *     This method will be called once and only once per implementation.
     * </p>
